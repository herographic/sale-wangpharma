...
class Purchase {
  ...
  // Factory constructor to create a Purchase object from a map (e.g., from CSV row).
  factory Purchase.fromMap(Map<String, dynamic> map) {
    return Purchase(
      date: map['วันที่']?.toString() ?? '',
      cd: map['CD']?.toString() ?? '',
      invoiceNumber: map['เลขที่ใบกำกับ']?.toString() ?? '',
  ...
  // Converts the Purchase object to a map for Firestore.
